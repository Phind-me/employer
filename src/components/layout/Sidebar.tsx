...
const SidebarItem: React.FC<SidebarItemProps> = ({ icon, text, active = false }) => {
  return (
    <li className={`group px-3 py-2 rounded-md ${active ? 'bg-indigo-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-50'}`}>
        ...
        <div className="overflow-y-auto py-5 px-3 flex-grow">
          <nav className="mt-5">
            <ul className="space-y-2">
              ...
              <SidebarItem icon={<Users size={20} />} text="Candidates" />
              <SidebarItem icon={<Building2 size={20} />} text="Recruiters" />
